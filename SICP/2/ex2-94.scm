;; -*- Scheme -*-
;; 
;; Code for Exercise 2.93
;; $Id: ex-2.93.scm,v 1.2 2005/09/13 00:14:30 nobsun Exp $
...
(define (install-complex-package)
  ...
  (define (sub-complex z1 z2)
    (make-from-real-imag (add (real-part z1)1 z2)
...
;;----------------------------------------------------------
#|
(define p1 (make-polynomial 'x '((2 1) (0 1)))) ;; x^3+1 
(define p2 (make-polynomial 'x '((3 1) (0 1)))) ;; x^2+1
